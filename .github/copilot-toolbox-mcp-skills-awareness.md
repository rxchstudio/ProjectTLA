...
_Generated: 2026-05-18T00:06:19.640Z_
...
Workspace `mcp.json` _(folder: ProjectTLA)_

- **c:\CODE\ProjectTLA\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\enivi\AppData\Roaming\Code\User\mcp.json** — _File missing_
